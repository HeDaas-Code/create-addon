package com.example.createaddon.content.recipes;
...
public class CrushingRecipe implements Recipe<RecipeInput> {
    ...
    @Override public RecipeSerializer<?> getSerializer() {
        return com.example.createaddon.registry.ModRecipes.CRUSHING_SERIALIZER.get();
    }

    @Override public RecipeType<?> getType() {
        return com.example.createaddon.registry.ModRecipes.CRUSHING_TYPE.get();
    }
}